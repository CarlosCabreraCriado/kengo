            ...
            >
              ...
              <circle class="flow-dot flow-dot-1" r="6" fill="#e75c3e">
                <animateMotion
                  ...
                  path="M0,50 C150,20 250,80 400,50 C550,20 650,80 800,50 C950,20 1050,80 1200,50"
                />
              </circle>
  ...
  styles: [
    ...
    ============================================ */
      ...
      .title-accent {
        ...
        animation:
          fadeUp 0.6s ease-out 0.15s backwards,
    ...
    ============================================ */
      ...
      .step-article {
        position: relative;
        z-index: 1;
        animation: stepReveal 0.7s ease-out calc(var(--step-index) * 0.12s)
          backwards;
      }
    ...
    ============================================ */
      ...
      .pill {
        ...
        letter-spacing: 0.04em;
        opacity: 0;
        animation: pillFade 0.4s ease-out calc(0.4s + var(--pill-delay))
          forwards;
      }
  ...
  steps = [
    {
      ...
      accentSoft: '#f7a65e',
      iconBg:
        'linear-gradient(135deg, rgba(231, 92, 62, 0.12) 0%, rgba(247, 166, 94, 0.06) 100%)',
    },
    {
      id: 'actividad',
      number: 2,
      ...
      accentSoft: '#ffc98b',
      iconBg:
        'linear-gradient(135deg, rgba(247, 166, 94, 0.12) 0%, rgba(255, 200, 140, 0.06) 100%)',
    },
    {
      id: 'sesion',
      number: 3,
      ...
      accentSoft: '#ffe082',
      iconBg:
        'linear-gradient(135deg, rgba(239, 192, 72, 0.12) 0%, rgba(255, 224, 130, 0.06) 100%)',
    },
    {
      id: 'feedback',
      number: 4,
      ...
      accentSoft: '#86efac',
      iconBg:
        'linear-gradient(135deg, rgba(34, 197, 94, 0.12) 0%, rgba(134, 239, 172, 0.06) 100%)',
    },
  ];
}
