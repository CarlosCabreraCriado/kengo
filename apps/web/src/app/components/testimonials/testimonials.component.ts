      ...
      <div class="content-wrapper">
        ...
        <div class="section-header">
          ...
          <p class="section-subtitle">
            Fisioterapeutas y pacientes que ya transformaron su forma de
            trabajar.
          </p>
        </div>
            ...
            <article class="testimonial-card">
              ...
              <div class="quote-icon">
                <svg viewBox="0 0 32 32" fill="currentColor">
                  <path
                    d="M10 8C7.8 8 6 9.8 6 12v4c0 2.2 1.8 4 4 4h1l-2 6h3l2.5-7A4 4 0 0014 15v-3c0-2.2-1.8-4-4-4zm12 0c-2.2 0-4 1.8-4 4v4c0 2.2 1.8 4 4 4h1l-2 6h3l2.5-7A4 4 0 0026 15v-3c0-2.2-1.8-4-4-4z"
                  />
                </svg>
              </div>
