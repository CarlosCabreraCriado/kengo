    ...
    <section class="cta-section">
      ...
      <div class="cta-content">
        ...
        <div class="cta-buttons">
          <a href="https://kengoapp.com/registro" class="btn-primary">
  ...
  styles: [
    ...
    ---------------------------------------- */
      ...
      @keyframes waveMove2 {
        ...
        66% {
          transform: translateX(-1%) translateY(-6px);
        }
      }
    ...
    ---------------------------------------- */
      ...
      .stat-item {
        ...
        gap: 0.75rem;
        padding: 1rem;
        animation: statPop 0.5s ease-out calc(0.5s + var(--index) * 0.08s)
          backwards;
      }
