      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div class="text-center">
          ...
          <p class="text-xl text-gray-700 max-w-2xl mx-auto mb-8">
            Planes de ejercicios personalizados con videos guiados, seguimiento de progreso y conexion directa con tu fisioterapeuta.
          </p>
          <div class="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="https://app.kengoapp.com/registro" class="bg-white text-gray-900 px-8 py-4 rounded-full text-lg font-medium hover:bg-gray-100 transition-colors shadow-lg">
              Registrate como fisioterapeuta
            </a>
          </div>
        </div>
      </div>
