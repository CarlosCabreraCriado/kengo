...
const DEFAULT_GROUPS: SidebarNavGroup[] = [
  {
    ...
    items: [
      ...
      { id: 'plan', label: 'Mi plan', icon: 'fitness_center', route: '/mi-plan', matchPrefix: '/mi-plan' },
...
@Component({
    ...
    <aside class="ui2-sidebar">
                ...
                >
                  ...
                  @if (item.badge) {
                    <span
                      ...
                      [class.ui2-sidebar__item-badge--on-active]="activeId() === item.id"
                    >{{ item.badge }}</span>
                  }
                </a>
              } @else {
      ...
      <div class="ui2-sidebar__user-wrap">
        ...
        >
          ...
          <span class="material-symbols-outlined ui2-sidebar__user-cog" aria-hidden="true">settings</span>
        </button>
  ...
  styles: [`
    ...
    .ui2-sidebar__group { display: flex; flex-direction: column; gap: 2px; }
    ...
    .ui2-sidebar__item:hover { background: rgba(0, 0, 0, 0.03); }
    ...
    .ui2-sidebar__item--disabled:hover { background: transparent; }
    .ui2-sidebar__item-icon { font-size: 18px; flex-shrink: 0; }
    .ui2-sidebar__item-label { flex: 1; min-width: 0; }
    ...
    .ui2-sidebar__user-wrap { position: relative; flex-shrink: 0; }
    .ui2-sidebar__user {
      display: flex;
      align-items: center;
      gap: 10px;
    ...
    .ui2-sidebar__user:hover { background: var(--cream-50); }
