/**
 * Subcomponentes presentacionales de la página `/mi-clinica`.
 * Todos standalone + OnPush + signals. Selector `app-mc-*` (mc = mi-clínica).
 * No promovidos a `ui2-*` por uso único en esta pantalla.
 */
export { MiClinicaHeroComponent } from './clinic-hero/clinic-hero.component';
