...
// Shell
export { ActividadShellComponent } from './pages/actividad-shell/actividad-shell.component';

// Pages
export { ActividadHoyComponent } from './pages/actividad-hoy/actividad-hoy.component';
